//---variable auxiliar para la función validarNombreCorreo---//
var auxlog;
//-----------------------------------------------------//
...
function fNombre(){
    ...
    xhttp.open("GET", "../controller/consultar-usuario-correo.php?nombre=" + nombre, true);
    xhttp.send();
...
function fCorreo(){
    ...
    xhttp.open("GET", "../controller/consultar-usuario-correo.php?correo=" + correo, true);
    xhttp.send();
...
function validar(){
    ...
    if(aux_n == 0 || aux_c == 0 || fClave() == 0 || frClave() == 0){
        ...
        swal("Verifique los datos para poder continuar");
        return false;
    ...
    xhttp.onreadystatechange = function() {
        if (this.readyState == 4 && this.status == 200) {
            ...
            if(resultado == 0){
                ...
                document.getElementById("tlogin").innerHTML = "Nombre de usuario o correo incorrecto";
                auxlog = 1;

            }else{
                
                document.getElementById("tlogin").innerHTML = "";
                auxlog = 0;
                
        }
      }
    }
    xhttp.open("GET", "controller/consultar-usuario-correo.php?valor=" + valor, true);
    xhttp.send();
